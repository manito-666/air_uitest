...
def roll(a, shift, axis=None):
    ...
    See Also
    --------
    rollaxis : Roll the specified axis backwards, util it lies in a
               given position.
...
def rollaxis(a, axis, start=0):
    """
    Roll the specified axis backwards, util it lies in a given position.
    ...
    start : int, optional
        When ``start <= axis``, the axis is rolled back util it lies in
        this position. When ``start > axis``, the axis is rolled util it
