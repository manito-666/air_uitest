...
def _formatArray(a, format_function, line_width, next_line_prefix,
    ...
    def recurser(index, hanging_indent, curr_width):
        ...
        if axes_left == 1:
            # the length up util the beginning of the separator / bracket
            if legacy == '1.13':
...
def format_float_scientific(x, precision=None, unique=True, trim='k',
    ...
    pad_left : non-negative integer, optional
        Pad the left side of the string with whitespace util at least that
        many characters are to the left of the decimal point.
    exp_digits : non-negative integer, optional
        Pad the exponent with zeros util it contains at least this many digits.
...
def format_float_positional(x, precision=None, unique=True,
    ...
    pad_right : non-negative integer, optional
        Pad the right side of the string with whitespace util at least that
