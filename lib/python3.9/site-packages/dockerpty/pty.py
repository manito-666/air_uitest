...
class RunOperation(Operation):
    ...
    def start(self, sockets=None, **kwargs):
        ...
        This will take over the current process' TTY util the container's PTY
        is closed.
        """
...
class PseudoTerminal(object):
    ...
    The PTY is managed via the current process' TTY util it is closed.
    ...
    Example:
        ...
        # hijacks the current tty util the pty is closed
