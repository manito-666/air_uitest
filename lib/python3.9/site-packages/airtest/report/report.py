...
class LogToHtml(object):
    ...
    def get_relative_log(self, output_file):
        ...
        :param output_file: output file: 2021-11-18.html
        :return: ./log.txt or ""
        """
        try:
...
def get_parger(ap):
    ...
    ap.add_argument("--outfile", help="output html filepath, default to be 2021-11-18.html", default=HTML_FILE)
