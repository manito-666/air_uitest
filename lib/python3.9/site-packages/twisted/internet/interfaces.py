...
class IReactorCore(Interface):
    ...
    def run() -> None:
        ...
        state, then run the main loop util it is stopped with C{stop()} or
        C{crash()}.
        """
    ...
    def addSystemEventTrigger(
        ...
        **kwargs: object,
        ...
        Deferred.  The "during" phase will not execute util all of the
...
class IReactorDaemonize(Interface):
    ...
    def beforeDaemonize() -> None:
        ...
        may be called util L{afterDaemonize} is called.
        """
...
class IReactorFDSet(Interface):
    ...
    def addReader(reader: "IReadDescriptor") -> None:
        ...
        @param reader: An L{IReadDescriptor} provider that will be checked for
                       read events util it is removed from the reactor with
                       L{removeReader}.
        """
    ...
    def addWriter(writer: "IWriteDescriptor") -> None:
        ...
        @param writer: An L{IWriteDescriptor} provider that will be checked for
                       write events util it is removed from the reactor with
                       L{removeWriter}.
        """
...
class IPushProducer(IProducer):
    ...
    def pauseProducing() -> None:
        ...
        the time being, and to stop util C{resumeProducing()} is called.
        """
...
class ITransport(Interface):
    ...
    def loseConnection() -> None:
        ...
        will not be closed util the producer has been unregistered.
        """
...
class INegotiated(ISSLTransport):
    ...
    negotiatedProtocol = Attribute(
        ...
        selected protocol as C{bytes}. Note that util the handshake has
        completed this property may incorrectly return L{None}: wait util data
