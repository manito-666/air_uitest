...
class ReactorBase(PluggableResolverMixin):
    ...
    @ivar _started: A flag which is true from the time C{reactor.run} is called
        util the time C{reactor.run} returns.  This is used to prevent calls
    ...
    def _moveCallLaterSooner(self, delayedCall: DelayedCall) -> None:
        ...
        try:
            ...
            # Move elt up the heap util it rests at the right place.
            elt = heap[pos]
            while pos != 0:
                parent = (pos - 1) // 2
                if heap[parent] <= elt:
    ...
    if platform.supportsThreads():
        ...
        def callFromThread(  # type: ignore[override]
            ...
            # this is probably a bug in Jython, but util fixed this code
