...
class _ConsumerMixin:
    ...
    but not write:
      ...
      - disconnecting: A C{bool} which is C{False} util something like
      ...
      - disconnected: A C{bool} which is C{False} util the consumer no longer
...
class FileDescriptor(_ConsumerMixin, _LogOwner):
    ...
    def write(self, data: bytes) -> None:
        ...
        The data is buffered util the underlying file descriptor is ready
    ...
    def writeSequence(self, iovec: Iterable[bytes]) -> None:
        ...
        streaming producer is registered, it will be paused util the buffered
    ...
    def loseConnection(self):
        ...
        be closed util the producer is finished. Therefore, make sure you
