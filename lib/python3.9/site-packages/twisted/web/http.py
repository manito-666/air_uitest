...
class Request:
    ...
    @ivar _disconnected: A flag which is C{False} util the connection over
        ...
        @note: There are some caveats around the reliability of the delivery of
            this notification.
                ...
                2. In order to deliver this notification promptly when a client
                   ...
                   reading up util a finite (small) maximum buffer size before
                   it gives up and pauses the transport itself.  If this
                   occurs, you will not discover that the connection has gone
                   away util a timeout fires or util the application attempts
...
class _NoPushProducer:
    ...
    def pauseProducing(self):
        ...
        the time being, and to stop util resumeProducing() is called.
        """
...
class HTTPChannel(basic.LineReceiver, policies.TimeoutMixin):
    ...
    @ivar _waitingForTransport: A boolean that tracks whether the transport has
        ...
        don't want to unpause the transport util it asks us to produce again.
    ...
    @ivar _optimisticEagerReadSize: When a resource takes a long time to answer
        ...
        application util the previous request has been answered.  This means
    ...
    def lineReceived(self, line):
        """
        Called for each line from request util the end of headers when
    ...
    def dataReceived(self, data):
        ...
        if self._handlingRequest:
            ...
            if (
                ...
                # to get them to stop sending more request data util we're
    ...
    def pauseProducing(self):
        ...
        connection util the client pulls some data out. This is a bit of a
...
class HTTPFactory(protocol.ServerFactory):
    ...
    def buildProtocol(self, addr):
        ...
        # HTTPChannel, but that won't work for the TimeoutMixin util we fix
