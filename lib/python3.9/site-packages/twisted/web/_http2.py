...
class H2Connection(Protocol, TimeoutMixin):
    ...
    def pauseProducing(self):
        ...
        for the time being, and to stop util resumeProducing() is called.
        """
    ...
    def _sendPrioritisedData(self, *args):
        ...
        object and wait util it is called to resume executing.
        """
        ...
        while stream is None:
            try:
                ...
                # util a new one becomes available.
...
class H2Stream:
    ...
    def receiveDataChunk(self, data, flowControlledLength):
        ...
        through. Otherwise, buffers the chunk util we can start producing.
