...
class _WSGIResponse:
    ...
    @ivar _requestFinished: A flag which indicates whether it is possible to
        generate more response data or not.  This is L{False} util
        ...
        self.environ.update(
            {
                ...
                # Attend: request.content was owned by the I/O thread up util
    ...
    def startResponse(self, status, headers, excInfo=None):
        """
        The WSGI I{start_response} callable.  The given values are saved util
