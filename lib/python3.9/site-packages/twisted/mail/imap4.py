...
class MessageSet:
    ...
    def last(self):
        ...
        This is undefined util it has been set by assigning to this property.
        """
        return self._last
...
class IMAP4Server(basic.LineReceiver, policies.TimeoutMixin):
    ...
    def _searchFilter(self, query, id, msg, lastSequenceId, lastMessageId):
        """
        Pop search terms from the beginning of C{query} util there are none
...
def iterateInReactor(i):
    ...
    util the Deferred fires, otherwise the next iteration will be taken
