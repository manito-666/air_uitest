...
class TLSMemoryBIOProtocol(ProtocolWrapper):
    ...
    def _flushReceiveBIO(self):
        ...
        """
        # Keep trying this util an error indicates we should stop or we
    ...
    def loseConnection(self):
        ...
        # down the connection util we write some data to the connection which
    ...
    def write(self, bytes):
        ...
        # been registered, in which case writes can happen util the producer
        # is unregistered:
