...
class IWriteFile(Interface):
    ...
    def close():
        ...
        will not see their upload request complete util this Deferred has
        been fired.
        """
...
class FTPClient(FTPClientBasic):
    ...
    def _openDataConnection(self, commands, protocol):
        ...
        if self.passive:
            ...
            # util we get both the "226 Transfer complete" message on the
    ...
    def generatePortCommand(self, portCmd):
        ...
        # The problem is that we don't create the listening port util we need
    ...
    def quit(self):
        ...
        @return: A L{Deferred} that fires when the server acknowledges the
            I{QUIT} command.  The transport should not be disconnected util
