...
class AMPTests(TestCase):
    ...
    def test_lateAnswer(self):
        """
        Verify that a command that does not get answered util after the
    ...
    def test_liveFireCustomTLS(self):
        ...
        def secured(rslt):
            ...
            def pinged(rslt2):
                ...
                # cert util we negotiate.  we should be able to do this in
...
class ListOfDecimalTests(TestCase, ListOfTestsMixin):
    ...
    objects = {
        ...
        # it was redundant, util we realised that 1E6 has less precision
