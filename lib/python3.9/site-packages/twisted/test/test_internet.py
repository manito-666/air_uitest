...
class SystemEventTests(TestCase):
    ...
    def test_beforePhase(self):
        ...
        phase and not call the given object util the right event is fired.
        """
    ...
    def test_beforeReturnsDeferred(self):
        ...
        L{Deferred}, the C{'during'} phase should be delayed util it is called
        back.
        """
    ...
    def test_multipleBeforeReturnDeferred(self):
        ...
        return L{Deferred}s, the C{'during'} phase should be delayed util they
        are all called back.
        """
...
class DelayedTests(TestCase):
    ...
    def testGetDelayedCalls(self):
        ...
        # the reactor util we have all the timers set up. If we did, this
...
class CallFromThreadTests(TestCase):
    ...
    def test_scheduledThreadsNotRunUntilReactorRuns(self):
        """
        Scheduled tasks should not be run util the reactor starts running.
        """
