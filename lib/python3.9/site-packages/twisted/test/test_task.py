...
class _FakeReactor:
    ...
    def run(self):
        """
        Call timed events util there are no more or the reactor is stopped.
...
class ReactTests(unittest.SynchronousTestCase):
    ...
    def test_runsUntilAsyncCallback(self):
        """
        L{task.react} runs the reactor util the L{Deferred} returned by the
    ...
    def test_runsUntilAsyncErrback(self):
        """
        L{task.react} runs the reactor util the L{defer.Deferred} returned by
