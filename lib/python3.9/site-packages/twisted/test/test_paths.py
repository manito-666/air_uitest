...
class ExplodingFile:
    ...
    @ivar closed: A C{bool} which is C{False} util C{close} is called, then it
        is C{True}.
    """
...
class FilePathTests(AbstractFilePathTests):
    ...
    def testOpen(self):
        ...
        with appender.open("a+") as f:
            ...
            # necessary. The cursor is not at the end of the file util after
            # the first write.
    ...
    def test_changed(self):
        ...
        not re-read the status information from the filesystem util it is
