...
class Charstr:
    ...
    def decode(self, strio, length=None):
        ...
        @type strio: file
        @param strio: Bytes will be read from this file util the full string
            is decoded.
...
class Name:
    ...
    def decode(self, strio, length=None):
        ...
        @type strio: file
        @param strio: Bytes will be read from this file util the full Name
        is decoded.
...
class _OPTHeader(tputil.FancyStrMixin, tputil.FancyEqMixin):
    ...
    def decode(self, strio, length=None):
        ...
        @type strio: file
        @param strio: Bytes will be read from this file util the full
...
class Record_SRV(tputil.FancyEqMixin, tputil.FancyStrMixin):
    ...
    @ivar target: The domain name of the target host.  There MUST be one or
        ...
        section.  Unless and util permitted by future standards action, name
