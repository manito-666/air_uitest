...
class StreamManagerTests(unittest.TestCase):
    ...
    def test_sendNotConnected(self):
        ...
        The data should be cached util an XML stream has been established and
        initialized.
        """
        factory = xmlstream.XmlStreamFactory(xmlstream.Authenticator())
        sm = xmlstream.StreamManager(factory)
    ...
    def test_sendNotInitialized(self):
        ...
        The data should be cached util the XML stream has been initialized.
        """
        factory = xmlstream.XmlStreamFactory(xmlstream.Authenticator())
        sm = xmlstream.StreamManager(factory)
        xs = factory.buildProtocol(None)
    ...
    def test_sendDisconnected(self):
        ...
        The data should be cached util a new XML stream has been established
        and initialized.
        """
        factory = xmlstream.XmlStreamFactory(xmlstream.Authenticator())
        sm = xmlstream.StreamManager(factory)
