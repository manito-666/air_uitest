...
class Service(object):
    ...
    def scale(self, desired_num, timeout=None):
        ...
        - creates containers util there are at least `desired_num`
        - stops containers util there are at most `desired_num` running
        - starts containers util there are at least `desired_num` running
    ...
    def _get_container_create_options(
        ...
        # util Docker Engine 1.11.0 - Docker API 1.23.
