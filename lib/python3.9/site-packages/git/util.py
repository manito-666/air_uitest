...
class BlockingLockFile(LockFile):
    ...
    """The lock file will block util a lock could be obtained, or fail after
    a specified timeout.
    ...
    def __init__(self, file_path: PathLike, check_interval_s: float = 0.3, max_block_time_s: int = maxsize) -> None:
        ...
        :param check_interval_s:
            Period of time to sleep util the lock is checked the next time.
    ...
    def _obtain_lock(self) -> None:
        """This method blocks util it obtained the lock, or raises IOError if
