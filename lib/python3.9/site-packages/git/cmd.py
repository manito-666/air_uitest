...
class Git(LazyMixin):
        ...
        if not has_git:
            ...
            if old_git is None:
                ...
                if mode in quiet:
                    ...
                    err = dedent("""\
                        %s
                        All git commands will error util this is rectified.
    ...
    def execute(self,
        ...
        :param kill_after_timeout:
            ...
            set to None by default and will let the process run util the timeout is
            ...
            render the repository incapable of accepting changes util the lock is manually
            removed.
