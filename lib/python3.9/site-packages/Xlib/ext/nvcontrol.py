...
# locked util released by the GLX_NV_video_out/GLX_NV_present_video
# client.
#
...
# take effect util the next POST.
#
...
# guarantee that the FillRectangle request is not processed util after the
