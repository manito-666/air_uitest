...
class Display(object):
    ...
    def sync(self):
        """Flush the queue and wait util the server has processed all
    ...
    def next_event(self):
        ...
        block util the next event is fetched from the server."""
    ...
    def grab_server(self, onerror = None):
        ...
        util the server is ungrabbed. Server grabbing should be avoided
        as much as possible."""
